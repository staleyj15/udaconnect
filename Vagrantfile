...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.box_version = default_version
    master.vm.hostname = "master"
    master.vm.synced_folder ".", "/home/vagrant/udaconnect"
    master.vm.network 'private_network', ip: "192.168.56.3",  virtualbox__intnet: true
